...
oauth {
	providers {
		facebook {
			...
			key = 'YOUR KEY'
			secret = 'YOUR SECRET'
			successUri = 'http://localhost:8080/grails-facebook-auth/oauthCallback/success'
			failureUri = 'http://localhost:8080/grails-facebook-auth/oauthCallback/error'
			callback = "http://localhost:8080/grails-facebook-auth/oauth/facebook/callback"
		}
	}
}
